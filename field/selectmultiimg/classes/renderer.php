 ...
 *
 */
class dataformfield_selectmultiimg_renderer extends mod_dataform\pluginbase\dataformfieldrenderer {
    ...
    public function display_browse($entry, $params = null) {
        ...
        if (isset($entry->{"c{$fieldid}_content"})) {
            ...
            foreach ($options as $key => $option) {
                ...
                if ($showalloptions) {
                    $str[] = "$selected ".$this->option_to_image($option);
                } else if ($selected) {
                    $str[] = $this->option_to_image($option);
                }
            }
    ...
    private function option_to_image($option) {
        $result = $option;
    ...
    public function get_pattern_import_settings(&$mform, $patternname, $header) {
        ...
        $labels = array_merge($labels, array(' '. get_string('allowaddoption', 'dataformfield_selectmultiimg'). ': '));
