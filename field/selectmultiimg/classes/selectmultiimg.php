...
/**
 * @package dataformfield_selectmultiimg
 * @copyright 2014 Itamar Tzadok
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

class dataformfield_selectmultiimg_selectmultiimg extends mod_dataform\pluginbase\dataformfield {
    ...
    public function get_separator_types() {
        return array(
            array('name' => get_string('newline', 'dataformfield_selectmultiimg'), 'chr' => '<br />'),
            array('name' => get_string('space', 'dataformfield_selectmultiimg'), 'chr' => '&#32;'),
            array('name' => get_string('comma', 'dataformfield_selectmultiimg'), 'chr' => '&#44;'),
            array('name' => get_string('commaandspace', 'dataformfield_selectmultiimg'), 'chr' => '&#44;&#32;')
        );
    }
